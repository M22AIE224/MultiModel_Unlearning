...
def main(args):
    ...
    # full_df=pd.read_parquet("/data/models/MLLMU-Bench/Full_Set/train-00000-of-00001.parquet")

    multimodal_full_dataset = Vanilla_LLaVA_Dataset(df=full_df)
    ...
    for epoch in range(args.num_epochs):
        ...
        if args.gradient_accumulation:
            ...
            for batch in progress_bar:
                outputs = model(**batch)
                tmp=model.generate(**batch, max_new_tokens=20, do_sample=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--forget_split_ratio", type=int, default=0, help="Ratio of forget split")
